package com.jrafika.jrafika.task.ocr.handwriting
...
class ImageHandwritingActivity: BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setTitle(getString(R.string.image_handwriting_title))
        ...
        blackWhiteOptionFragment.proceedFunction = { bwImage ->
            ...
            ImageTask(predictionImageFragment, ImageNoiseRemover())
                    ...
                    .then(ImageTask(predictionImageFragment, HandwritingPredictor(this)))
                    .execute(bwImage)

...
class GreenHistogramFragment: Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        titleView.text = resources.getText(R.string.green_histogram)
    }
    ...
    fun showHistogram(histogram: Array<Int>) {
        ...
        val dataSet = LineDataSet(entries, resources.getText(R.string.green_histogram).toString())
        dataSet.color = R.color.colorGreen
